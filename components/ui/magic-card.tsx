...
export function MagicCard(props: MagicCardProps) {
  ...
  const glowFrom = isOrbMode(props) ? (props.glowFrom ?? "#0284c7") : "#0284c7"
  const glowTo = isOrbMode(props) ? (props.glowTo ?? "#7dd3fc") : "#7dd3fc"
    ...
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(var(--color-background, white) 0 0) padding-box,
